...
Dosage analysis game plan: Mick Song and Jeremy Coate provide good framework. Dichotmize dosage sensitivity based on their arabidopsis list of Class I and Class II genes
...
```{r Get expression and GO information for all four kinds of homoeologous exchange events}
...
```{r Calculate expression response to different kinds of homoeologous exchange events, combine the 4 HE classes, and calculate homoeologous exchange response variance}
